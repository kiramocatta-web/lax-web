// src/lib/email/templates/pass7Membership.ts

export const pass7MembershipTemplate = `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8" />
...
<body>
  <div class="wrapper">
    <div class="container">
      ...
      <img
        class="hero-image"
        src="https://www.laxnlounge.com.au/emails/pass7banner.png"
        alt="Welcome to your 7 Day LAX membership"
      />

      <div class="content">

        <div class="text">
          Thank you for loving LAX so much, that you went and got that membership!
        </div>

        <div class="text">
          Affordability and recovery never felt better.
        </div>
